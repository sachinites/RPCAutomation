...
gcc -g -c -I . rpc_client_implementation.c -o rpc_client_implementation.o
...
gcc -g test.o company_t_xdr_serialize.o person_t_xdr_serialize.o serialize.o rpc_client_implementation.o rpc_client.o complex_t_xdr_serialize.o tree_node_t_xdr_serialize.o tree_t_xdr_serialize.o -o client
...
gcc -g rpc_server_main.o rpc_server_init.o rpc_server.o serialize.o rpc_server_stubs.o rpc_server_implementation.o person_t_xdr_serialize.o company_t_xdr_serialize.o complex_t_xdr_serialize.o tree_node_t_xdr_serialize.o tree_t_xdr_serialize.o rpc_server_usercode1.o -o server
